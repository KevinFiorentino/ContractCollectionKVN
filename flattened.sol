...
// File @openzeppelin/contracts/utils/Base64.sol@v4.7.0
...
// File contracts/CalculateDNA.sol



pragma solidity >=0.8.4;

contract CalculateDNA {
    ...
    function deterministicPseudoRandomDNA(uint256 _tokenId, address _minter) public pure returns (uint256) {
        ...
        bytes memory endcodedParams = abi.encodePacked(combinedParams);
        bytes32 hashedParams = keccak256(endcodedParams);
...
// File contracts/CollectionKVN.sol
...
// File @openzeppelin/contracts/utils/introspection/ERC165Checker.sol@v4.7.0
...
// File @openzeppelin/contracts/access/AccessControl.sol@v4.7.0
...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20Burnable.sol@v4.7.0
